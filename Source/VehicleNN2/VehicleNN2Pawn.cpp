...
const FName AVehicleNN2Pawn::LookUpBinding("LookUp");
const FName AVehicleNN2Pawn::LookRightBinding("LookRight");
const FName AVehicleNN2Pawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"


////////////////////////////////////////////////////////////////////// Code that came with the VehicleAdv project
AVehicleNN2Pawn::AVehicleNN2Pawn()
{
	// Car mesh
...
void AVehicleNN2Pawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AVehicleNN2Pawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AVehicleNN2Pawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &AVehicleNN2Pawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &AVehicleNN2Pawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AVehicleNN2Pawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AVehicleNN2Pawn::OnResetVR); 
}

void AVehicleNN2Pawn::MoveForward(float Val)
{
	GetVehicleMovementComponent()->SetThrottleInput(Val);

}

void AVehicleNN2Pawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void AVehicleNN2Pawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void AVehicleNN2Pawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void AVehicleNN2Pawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void AVehicleNN2Pawn::EnableIncarView(const bool bState)
{
...
void AVehicleNN2Pawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void AVehicleNN2Pawn::UpdateHUDStrings()
{
...
void AVehicleNN2Pawn::SetupInCarHUD()
{
...
void AVehicleNN2Pawn::UpdatePhysicsMaterial()
{
...
void AVehicleNN2Pawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void AVehicleNN2Pawn::BeginPlay()
{
	Super::BeginPlay();
